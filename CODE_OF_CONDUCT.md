...
This Code of Conduct applies within all project spaces, including the GitHub repository, discussion forums, and when an individual is officially representing the project or its community in public spaces (e.g., official email, social media, conferences).
...
- **DOCTOR MOKIRA** (author): dr.mokira@gmail.com
- **CONSOLE ART CYBERNETIC** (maintainer): ca.cybernetic@gmail.com

All complaints will be reviewed and investigated promptly and fairly. The confidentiality of the reporting person will be respected.
...
**Consequence**: A temporary ban from any form of interaction or public communication with the community for a specified period of time. No public or private interaction with the people involved is allowed during this period. Violating these terms may lead to a permanent ban.
